...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		var levelInfo:FlxText = new FlxText(20, 15, 0, "", 30);
		...
		var levelDifficulty:FlxText = new FlxText(20, 15 + 32, 0, "", 30);
		...
		practiceText = new FlxText(20, 15 + 101, 0, "PRACTICE MODE", 30);
		practiceText.scrollFactor.set();
		practiceText.setFormat(Paths.font('vcr.ttf'), 30);
		practiceText.x = FlxG.width - (practiceText.width + 20);
		practiceText.updateHitbox();
		practiceText.visible = PlayState.instance.practiceMode;
		add(practiceText);

		var chartingText:FlxText = new FlxText(20, 15 + 101, 0, "CHARTING MODE", 30);
		chartingText.scrollFactor.set();
		chartingText.setFormat(Paths.font('vcr.ttf'), 30);
